!(function (e) {
    ...
    (a.prototype = {
        ...
        init: function (t) {
            ...
            if (
                ((this.default_options = {
                    ...
                    divlinkbg: "#F1D600",
                    position: "bottom",
                    message: "We use cookies to personalize your experience here on the site, in accordance with our cookie policy.",
                    linkmsg: "More info",
        ...
        insert: function () {
            ...
            (t.className = "cookieinfo container"),
                ...
                (t.style.boxShadow = "0 0 12px 0 rgba(0, 0, 0, 0.16)"),
                ...
                (t.innerHTML =
                    ...
                    " <a href='#' id='btnPolitica' style='text-decoration: underline!important;'>" +
                    this.options.linkmsg +
                    "</a>.<img> <a>" +
                    this.options.scriptmsg+"</span>"),
                (this.element = t);
            ...
            (n.href = this.options.scriptinfo), (n.style.textDecoration = "underline"), (n.style.display = "none"), (n.style.color = this.options.link);
